            ...
            $("#showtoast").click(function () {
                var p = $("#toastTypeGroup input:radio:checked").val(),
                    ...
                    e =
                        ...
                        r != toastr.options.positionClass &&
                        ...
                        o.val().length &&
                            (toastr.options.showDuration = parseInt(o.val())),
                        s.val().length &&
                            (toastr.options.hideDuration = parseInt(s.val())),
                        a.val().length &&
                            (toastr.options.timeOut = l
                                ? 0
                                : parseInt(a.val())),
                        n.val().length &&
                            (toastr.options.extendedTimeOut = l
                                ? 0
                                : parseInt(n.val())),
                ...
                void 0 !== (k = c) &&
                    (c.find("#okBtn").length &&
                        c.delegate("#okBtn", "click", function () {
                            alert(
                    ...
                    c.find("#surpriseBtn").length &&
                        c.delegate("#surpriseBtn", "click", function () {
                            alert(
                    ...
                    c.find(".clear").length &&
                        c.delegate(".clear", "click", function () {
                            toastr.clear(c, {
                                force: !0,
                            });
                        }));
