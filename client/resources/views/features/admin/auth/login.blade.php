...
>
  <head>
    ...
    <!-- Favicon -->
    {{-- <link rel="icon" type="image/x-icon" href="{{asset('assets/admin/assets/img/fa')}} ../assets/img/favicon/favicon.ico" /> --}}
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/assets/css/theme-default.css') }} " class="template-customizer-theme-css" />
  ...
  <body>
    ...
    <script src="{{ asset('assets/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}"></script>
