                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex">
                                    <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                                        <img src="{{ asset('assets/admin/') }}/assets/img/icons/misc/pdf.png"
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="avatar me-3">
                                        <img src="{{ asset('assets/admin/') }}/assets/img/avatars/3.png" alt="Avatar"
                            ...
                            <div class="timeline-event pb-0">
                                ...
                                <div class="d-flex align-items-center avatar-group">
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        ...
                                        <img src="{{ asset('assets/admin/') }}/assets/img/avatars/5.png" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Marrie Patty">
                                        <img src="{{ asset('assets/admin/') }}/assets/img/avatars/12.png" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Jimmy Jackson">
                                        <img src="{{ asset('assets/admin/') }}/assets/img/avatars/9.png" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Kristine Gill">
                                        <img src="{{ asset('assets/admin/') }}/assets/img/avatars/6.png" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Nelson Wilson">
                                        <img src="{{ asset('assets/admin/') }}/assets/img/avatars/14.png" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-borderless text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/chrome.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/safari.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/firefox.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/edge.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/opera.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/brave.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/vivaldi.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/uc.png"
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/windows.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/mac.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/ubuntu.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/cent.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/linux.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/fedora.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/img/icons/brands/vivaldi-os.png"
                                                    alt="Vivaldi" height="24" class="me-2">
                                                <span>Vivaldi</span>
                                            </div>
                                        </td>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/us.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/br.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/in.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/au.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/de.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/fr.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/pt.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/admin/') }}/assets/svg/flags/cn.svg"
