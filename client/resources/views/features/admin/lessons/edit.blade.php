...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text"name="name" class="form-control" id="chapter" value="{{ $lesson['name'] }}"
    ...
    <div class="row">
        <div class="col mb-0">
            ...
            <input type="text" id="video" class="form-control" value="{{ $lesson['video'] }}"
                placeholder="pZqk57Xvujs">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary edit-lesson" id="save-chapter">Save changes</button>
</div>
