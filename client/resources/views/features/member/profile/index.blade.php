                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img class="img-account-profile rounded-circle mb-2" id="preview" src="{{$user['avatar']}}" alt="" width="100px">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('member.profile.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" name="name" type="text" placeholder="Enter your username" value="{{old('username' ,$user['name'])}}">
                                </div>
                                <!-- Form Row-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="password" class="form-control  @error('old_password') is-invalid @enderror"
                                                placeholder="Password Old" aria-label="password" aria-describedby="basic-addon1"
                                                name="password_old" id="old_password" value="{{old('password_old')}}">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button" id="togglePasswordOld">
                                    ...
                                    <div class="col-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="password" class="form-control  @error('password') is-invalid @enderror"
                                                    ...
                                                    name="password" id="new_password" value="{{old('password')}}">
                                                <div class="input-group-append">
