<div class="col-lg-2">
    <div style="border-radius: 10px ;"
        class="card  shadow-sm border-0 sticky-top d-none d-lg-block">
        <div class="card-body p-2 p-xl-3">
            <ul class="nav nav-pills flex-column border-0">
                <a class="nav-link d-flex flex-column text-center py-3" href="/learn">
                    ...
                    <div class="fw-semilight text-muted small"><span
                            class="d-none d-xl-block">Dashboard</span></div>
                </a>
                <a class="nav-link d-flex flex-column text-center py-3" href="/learn">
                ...
                <a class="nav-link d-flex flex-column text-center py-3" onclick="event.preventDefault();
